...
@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('gallery.Photo Album') }}</li>
@endsection

@section('content')
<div class="container">
    <h1 class="text-center">{{ __('gallery.Photo Album') }}</h1>
    <div class="row justify-content-center mt-5">
        ...
        <form action="/photo/create" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="dir" id="dir" value="album_1"/>
                ...
                <div class="card-columns">
                    ...
                    <div class="card border-light shadow">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="/gallery/{{ $photo->__get('album') }}/photo/{{ $photo->__get('basename') }}" method="post">        
                        ...
                        <a data-fancybox="gallery" href="{{ $photo->__get('path') }}">
                            <img class="card-img-top rounded" src="{{ $photo->__get('path') }}" alt="{{ $photo->__get('album') }}_{{ $photo->__get('filename') }}" />
                        </a>
                        @can('admin', Auth::user())
